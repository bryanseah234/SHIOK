...
def test_native_osm_covered_mask_includes_underground_and_indoor_location():
    edges = gpd.GeoDataFrame(
        [
            ...
            },
            {
                "highway": "footway",
                "shelter_type": "roof",
                "geometry": LineString([(0, 6), (1, 6)]),
            },
            {
                "highway": "footway",
                "man_made": "canopy",
                "geometry": LineString([(0, 7), (1, 7)]),
            },
            {
                "highway": "footway",
                "building:part": "roof",
                "geometry": LineString([(0, 8), (1, 8)]),
            },
            {
                "highway": "footway",
                "building": "canopy",
                "geometry": LineString([(0, 9), (1, 9)]),
            },
        ],
        crs="EPSG:3414",
    )
    ...
    assert mask.tolist() == [True, True, False, True, True, True, True, True, True, True]
...
def test_prepare_osm_explicit_shelter_geometries_filters_supported_tags():
    features = gpd.GeoDataFrame(
        [
            ...
            {
                "building": "canopy",
                "geometry": Polygon([(90, 0), (95, 0), (95, 5), (90, 5)]),
            },
            {
                "amenity": "shelter",
                "shelter": "no",
