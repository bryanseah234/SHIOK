...
Bundle: `generated_20260802_bus_connector_tolerance_targeted`
...
- `560234`: state `SCORED`, total `90.6`
  - best_transit: `SCORED`, total `90.6`, node `Mayflower Sec Sch`, distance `332.4`, covered `0.766`
  - mrt_lrt: `SCORED`, total `72.6`, node `MAYFLOWER MRT STATION Exit 5`, distance `632.9`, covered `0.523`
  - bus: `SCORED`, total `90.6`, node `Mayflower Sec Sch`, distance `332.4`, covered `0.766`
