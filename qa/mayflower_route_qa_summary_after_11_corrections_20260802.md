...
Bundle: `generated_20260802_mayflower_11_corrections_targeted`
...
- `560234`: state `SCORED`, total `89.9`
  - best_transit: `SCORED`, total `89.9`, node `Mayflower Sec Sch`, distance `307.9`, covered `0.747`
  - mrt_lrt: `SCORED`, total `72.6`, node `MAYFLOWER MRT STATION Exit 5`, distance `632.9`, covered `0.523`
  - bus: `SCORED`, total `89.9`, node `Mayflower Sec Sch`, distance `307.9`, covered `0.747`
- `560225`: state `SCORED`, total `85.9`
  - best_transit: `SCORED`, total `85.9`, node `Mayflower Sec Sch`, distance `406.3`, covered `0.684`
  - mrt_lrt: `SCORED`, total `59.7`, node `MAYFLOWER MRT STATION Exit 5`, distance `646.9`, covered `0.363`
  - bus: `SCORED`, total `85.9`, node `Mayflower Sec Sch`, distance `406.3`, covered `0.684`
- `560700`: state `SCORED`, total `85.4`
  - best_transit: `SCORED`, total `85.4`, node `Blk 700B`, distance `202.9`, covered `0.636`
  - mrt_lrt: `SCORED`, total `77.4`, node `ANG MO KIO MRT STATION Exit D`, distance `681.8`, covered `0.641`
  - bus: `SCORED`, total `85.4`, node `Blk 700B`, distance `202.9`, covered `0.636`
- `560710`: state `SCORED`, total `100.0`
  - best_transit: `SCORED`, total `100.0`, node `Aft Ang Mo Kio Int`, distance `76.6`, covered `1.0`
  - mrt_lrt: `SCORED`, total `87.4`, node `ANG MO KIO MRT STATION Exit D`, distance `282.8`, covered `0.674`
  - bus: `SCORED`, total `100.0`, node `Aft Ang Mo Kio Int`, distance `76.6`, covered `1.0`
...
- `560700`: `{'covered_evidence_nearby_check_connectivity_or_snap': 7, 'bridge_underpass_evidence_nearby_check_endpoint_snap': 1}`
- `560710`: `{'covered_evidence_nearby_check_connectivity_or_snap': 2, 'user_marked_exposed_no_shelter_expected': 1}`
...
- approved source-backed corrections: `9`
