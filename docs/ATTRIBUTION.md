...
| 6A | data.gov.sg — Train Station Codes and Chinese Names | Singapore Open Data Licence v1.0 | "Contains information from Train Station Codes and Chinese Names dataset accessed from data.gov.sg under the Singapore Open Data Licence v1.0." | Site footer & dataset README |
