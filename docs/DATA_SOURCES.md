...
| 17 | Overture Maps Addresses — Singapore candidate | Overture Addresses GeoParquet, release `2026-07-22.0`, path `s3://overturemaps-us-west-2/release/2026-07-22.0/theme=addresses/type=address/*` | GeoParquet | Candidate only. Overture docs list SG at 142,210 address rows, but local probe found 123,883 unique six-digit postcodes, 1,687 new vs current universe, and 1,836 current postcodes missing from Overture. Theme is Alpha; source is OpenAddresses/SLA/OneMap-derived. Do not replace the current universe without raw subset archive, hash/provenance, attribution, dedupe, and sample-coordinate validation. |
