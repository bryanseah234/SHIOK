...
| 9 | Postal / building points | data.gov.sg HDB/building datasets + OSM `addr:postcode` + reviewed postal-universe candidates | CSV/GeoJSON/JSON | No authoritative free all-postal-code file has been found. Use `python run.py postal-universe` and `docs/POSTAL_UNIVERSE.md`; OneMap brute-force enumeration remains forbidden. |
