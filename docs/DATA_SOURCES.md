...
| 9 | Postal / building points | data.gov.sg HDB Existing Building + SLA Dwelling Information + OSM `addr:postcode` + reviewed postal-universe candidates | CSV/GeoJSON/JSON | No authoritative free all-postal-code file has been found. Use `python run.py postal-universe` and `docs/POSTAL_UNIVERSE.md`; OneMap brute-force enumeration remains forbidden. |
...
| 14 | NParks Nature Ways / green corridors | data.gov.sg NParks datasets: Nature Ways `d_af948e3f29cd12bc8b0caea19ae68286`, Park Connector Loop `d_a69ef89737379f231d2ae93fd1c5707f`, NParks Tracks `d_306cc1018cb733346681883ee6d73054`, Heritage Trees `d_644ff187b6d14d6316f47284a4a6c81f` | GeoJSON / mixed | Candidate Phase 4 shade/green-route evidence. These are spatial proxies, not rain shelter, and need model validation before scoring. |
