...
- Run and fix the Lighthouse/accessibility pass: homepage Lighthouse a11y is 100 in `qa/lighthouse_a11y_20260802_summary.md`; keyboard-only routed-search walkthrough, screenshots, and mobile readability review still need a browser QA pass.
